  ...
  if (!hasDemoData) {
    ...
    const demoTransactions: Transaction[] = [
      ...
      },
      {
        ...
        amount: 15,
        description: "Ticket purchase - Fast Draw",
        timestamp: new Date(now.getTime() - 6 * 24 * 60 * 60 * 1000).toISOString(),
        status: "completed",
        lotteryTitle: "Fast Draw",
      },
      {
        id: generateTransactionId(),
        type: "prize_won",
        amount: 500,
        description: "Prize won - Weekly Draw #45",
        timestamp: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000).toISOString(),
        status: "completed",
        lotteryTitle: "Weekly Draw #45",
        ticketNumber: "112233",
      },
      {
        id: generateTransactionId(),
        type: "deposit",
        amount: 250,
        description: "USDT Deposit - TRC-20",
      ...
      },
      {
        ...
        type: "ticket_purchase",
        amount: 20,
        description: "Ticket purchase - Mega Draw",
        timestamp: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000).toISOString(),
        status: "completed",
        lotteryTitle: "Mega Draw",
      },
      {
        id: generateTransactionId(),
        type: "withdrawal",
        amount: 51,
        description: "USDT Withdrawal - BSC",
      ...
      },
      {
        ...
        type: "prize_won",
        amount: 1000,
        description: "Prize won - Mega Draw #12",
        timestamp: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString(),
        status: "completed",
        lotteryTitle: "Mega Draw #12",
        ticketNumber: "445566",
      },
      {
        id: generateTransactionId(),
...
export const addTransaction = (userId: string, transaction: Omit<Transaction, "id" | "timestamp">) => {
  ...
  if (transaction.type === "deposit" && transaction.status === "completed") {
    ...
    addNotification(userId, {
      ...
      message: `Your deposit of ${transaction.amount} USDT has been confirmed and added to your balance`,
